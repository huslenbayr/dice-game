...
function translateSite(site = {}) {
  ...
  return {
    ...
    home: {
      ...home,
      eyebrow: mergeLocalizedValue(home.eyebrow, SITE_TRANSLATIONS.home.eyebrow),
      heroTitle: mergeLocalizedValue(home.heroTitle, SITE_TRANSLATIONS.home.heroTitle),
      heroSubtitle: mergeLocalizedValue(home.heroSubtitle, SITE_TRANSLATIONS.home.heroSubtitle),
      sectionIntro: mergeLocalizedValue(home.sectionIntro, SITE_TRANSLATIONS.home.sectionIntro),
      storyTitle: mergeLocalizedValue(home.storyTitle, SITE_TRANSLATIONS.home.storyTitle),
      storyBody: mergeLocalizedValue(home.storyBody, SITE_TRANSLATIONS.home.storyBody)
    },
    about: {
      ...about,
      title: mergeLocalizedValue(about.title, SITE_TRANSLATIONS.about.title),
      intro: mergeLocalizedValue(about.intro, SITE_TRANSLATIONS.about.intro),
      approachTitle: mergeLocalizedValue(about.approachTitle, SITE_TRANSLATIONS.about.approachTitle),
      approachBody: mergeLocalizedValue(about.approachBody, SITE_TRANSLATIONS.about.approachBody)
    },
    contactPage: {
      ...contactPage,
      title: mergeLocalizedValue(contactPage.title, SITE_TRANSLATIONS.contactPage.title),
      body: mergeLocalizedValue(contactPage.body, SITE_TRANSLATIONS.contactPage.body)
    },
