export const UI_LOCALES = {
  en: {
    ...
    auth: {
      ...
      googleErrorMessage: "Google sign-in couldn't be completed. Please try again or use email and password.",
      fields: {
        fullName: "Full name",
        email: "Email",
        phone: "Phone",
  ...
  mn: {
    ...
    auth: {
      ...
      googleErrorMessage: "Google-ээр нэвтрэх үйлдэл амжилтгүй боллоо. Дахин оролдох эсвэл имэйл, нууц үгээ ашиглана уу.",
      fields: {
        fullName: "Овог нэр",
        email: "Имэйл",
        phone: "Утас",
  ...
  ja: {
    ...
    auth: {
      ...
      googleErrorMessage: "Googleログインを完了できませんでした。もう一度試すか、メールとパスワードを使用してください。",
      fields: {
        fullName: "氏名",
        email: "メール",
        phone: "電話",
  ...
  ko: {
    ...
    auth: {
      ...
      googleErrorMessage: "Google 로그인을 완료할 수 없었습니다. 다시 시도하거나 이메일과 비밀번호를 사용해 주세요.",
      fields: {
        fullName: "이름",
        email: "이메일",
        phone: "전화",
  ...
  es: {
    ...
    auth: {
      ...
      googleErrorMessage: "No se pudo completar el acceso con Google. Inténtalo otra vez o usa correo y contraseña.",
      fields: {
