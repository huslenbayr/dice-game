export const UI_LOCALES = {
  en: {
    ...
    common: {
      ...
      playVideo: "Play hero video",
      exchangeRateCached: "Using a recently saved exchange rate.",
      exchangeRateBackup: "Live rate unavailable. Using a backup conversion.",
      dayLabel: "Day {day}",
      openMenu: "Open menu",
  ...
  mn: {
    ...
    common: {
      ...
      getStarted: "Эхлэх",
      playVideo: "Нүүр видеог тоглуулах",
      exchangeRateCached: "Саяхан хадгалсан ханшийг ашиглаж байна.",
      exchangeRateBackup: "Шууд ханш авах боломжгүй байна. Нөөц хөрвүүлэлт ашиглаж байна.",
  ...
  ja: {
    ...
    common: {
      ...
      getStarted: "はじめる",
      playVideo: "ヒーロー動画を再生",
      exchangeRateCached: "直近で保存した為替レートを使用しています。",
      exchangeRateBackup: "最新レートを取得できないため、予備の換算値を使用しています。",
      dayLabel: "{day}日目",
      openMenu: "メニューを開く",
      closeMenu: "メニューを閉じる",
    ...
    payment: {
      ...
      title: "チェックアウト方法",
      body:
        "旅行者の状況に合った支払い方法を選択してください。海外旅行者にはカード決済が優先され、国内利用者にはQPayのQRとディープリンク導線を用意しています。",
      reference: "参照番号",
      ...
      internationalHint: "この予約は海外旅行者向けのため、カード決済を先に表示しています。",
    ...
    auth: {
      ...
      providersBody: "現在はパスワードログインが有効で、後でGoogleログインを追加できる構成になっています。",
      signInTab: "ログイン",
      registerTab: "アカウント作成",
      signInTitle: "おかえりなさい",
  ...
  ko: {
    ...
    common: {
      ...
      getStarted: "시작하기",
      playVideo: "히어로 영상 재생",
      exchangeRateCached: "최근 저장된 환율을 사용하고 있습니다.",
      exchangeRateBackup: "실시간 환율을 불러오지 못해 예비 환율을 사용하고 있습니다.",
      dayLabel: "{day}일차",
      openMenu: "메뉴 열기",
      closeMenu: "메뉴 닫기",
    ...
    payment: {
      ...
      title: "체크아웃 옵션",
      body:
        "여행자 상황에 맞는 결제 경로를 선택하세요. 해외 여행자에게는 카드 결제가 우선이며, 현지 이용자에게는 QPay QR 및 딥링크 흐름을 준비해 두었습니다.",
      reference: "참조 번호",
      ...
      internationalHint: "이 예약은 해외 여행자에 가까워 카드 결제를 먼저 보여줍니다.",
    ...
    auth: {
      ...
      providersBody: "현재는 비밀번호 로그인이 활성화되어 있으며, 이후 Google 로그인을 추가할 수 있도록 준비되어 있습니다.",
      signInTab: "로그인",
      registerTab: "계정 만들기",
  ...
  es: {
    ...
    common: {
      ...
      getStarted: "Comenzar",
      playVideo: "Reproducir video principal",
      exchangeRateCached: "Se está usando un tipo de cambio guardado recientemente.",
      exchangeRateBackup: "La tasa en vivo no está disponible. Se usa una conversión de respaldo.",
      dayLabel: "Día {day}",
      openMenu: "Abrir menú",
    ...
    payment: {
      ...
      body:
        "Elige la ruta de pago que mejor se adapte al viajero. El pago con tarjeta es la opción principal para viajeros internacionales, mientras que QPay queda listo para flujos locales con QR y deep link.",
      ...
      internationalHint: "Esta reserva parece internacional, por eso se muestra primero el pago con tarjeta.",
    ...
    auth: {
      ...
      providersBody: "El acceso con contraseña ya está activo y la estructura queda lista para Google más adelante.",
