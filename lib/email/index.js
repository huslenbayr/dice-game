...
function buildBaseEmailLayout(title, content) {
  return `
    <div style="font-family:Arial,sans-serif;background:#f4f1ea;padding:32px;">
      <div style="max-width:640px;margin:0 auto;background:#ffffff;border-radius:24px;padding:32px;color:#18222f;">
        <p style="margin:0 0 12px;font-size:12px;letter-spacing:0.2em;text-transform:uppercase;color:#8a7b63;">MongolWay</p>
